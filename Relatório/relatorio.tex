...
Ainda assim, reconhecemos que o projeto poderia ter sido melhorado com a introdução de concorrência também no Processing, por exemplo, através da utilização de uma thread dedicada a cada tipo de operação no código Java. Apesar dessa possível evolução, estamos satisfeitos com o trabalho desenvolvido e com os resultados alcançados.
